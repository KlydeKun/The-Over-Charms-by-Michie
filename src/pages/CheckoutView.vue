<template>
  <main class="max-w-5xl mx-auto px-5 sm:px-6 pt-6 pb-24">
    ...
    <form @submit="onSubmit" class="grid lg:grid-cols-[1fr_360px] gap-8">
      <div class="space-y-8">
        <section>
          ...
          <div class="grid grid-cols-2 gap-3">
            <Button
              v-for="deliver in modeOfDelivery"
              :key="deliver"
              type="button"
              @click="handleFulfillment(deliver)"
              :class="[
          ...
          <div v-if="fulfillment === 'delivery'" class="space-y-4">
            ...
            <FormField v-slot="{ componentField }" name="instructions">
              <FormItem>
                ...
                <FormControl>
                  <Textarea v-bind="componentField" :class="[textAreaCls]" />
                </FormControl>
                <FormMessage />
              </FormItem>
            </FormField>
            ...
            <FormField v-slot="{ value, handleChange }" name="date">
              <FormItem class="flex flex-col">
                ...
                <Popover v-slot="{ close }">
                  ...
                  <PopoverContent
                    class="w-auto p-3 bg-card border border-foreground/10 shadow-lg rounded-2xl z-50"
                    align="start"
                  >
                    <Calendar
            ...
            <FormField v-slot="{ value, handleChange }" name="time">
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger
                      class="w-full rounded-xl border-foreground/10 bg-card py-6"
                    >
                  ...
                  <SelectContent
                    class="rounded-xl border-foreground/10 bg-card shadow-lg z-50"
                  >
                    <SelectGroup>
                      <SelectItem
      ...
      <aside
        class="bg-card border border-foreground/5 rounded-2xl p-5 h-fit lg:sticky lg:top-24 space-y-3"
      >
